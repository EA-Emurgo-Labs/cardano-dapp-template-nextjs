...
export const AuthLayout = ({ children, title }: PropsWithChildren<{}>) => {
  return (
      ...
      >
        <Image src={BgEllipse1} alt="background 1" class="absolute left-0 top-0" />
        <Image src={BgEllipse2} alt="background 2" class="absolute right-0 top-0" />
        <Image src={Logo} alt="Logo" className="relative" width="229" />
